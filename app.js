...
var listaRouter = require("./routes/listado");
...
const { empleadosCreatePost } = require("./controllers/empleadosController");
const mongoDB = "mongodb://localhost/presentismo";
